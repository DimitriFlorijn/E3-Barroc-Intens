        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Invoice>().HasData(
                ...
                new Invoice
                {
                    ...
                    DueDate = new DateTime(2028, 9, 30),
                ...
                new Invoice
                {
                    ...
                    DueDate = new DateTime(2031, 2, 28),
                ...
                new Invoice
                {
                    ...
                    DueDate = new DateTime(2033, 9, 30),
                ...
                new Invoice
                {
                    ...
                    DueDate = new DateTime(2038, 9, 30),
                ...
                { 
                    Id = 296, 
                    ContractId = 70, 
                    DateIssued = new DateTime(2048, 8, 31), 
                    DueDate = new DateTime(2048, 9, 30), 
                ...
                new Invoice
                {
                    ...
                    DueDate = new DateTime(2051, 2, 28),
            ...
            new Appointment { Id = 1, ClientId = 101, DateTime = new DateTime(2025, 1, 30, 9, 0, 0), Notes = "First appointment of the day." },
            new Appointment { Id = 2, ClientId = 102, DateTime = new DateTime(2025, 1, 30, 10, 0, 0), Notes = "Follow-up on previous meeting." },
            new Appointment { Id = 3, ClientId = 103, DateTime = new DateTime(2025, 1, 30, 11, 0, 0), Notes = "Discuss project progress." },
            new Appointment { Id = 4, ClientId = 104, DateTime = new DateTime(2025, 1, 30, 12, 0, 0), Notes = "Lunch meeting to discuss collaboration." },
            new Appointment { Id = 5, ClientId = 105, DateTime = new DateTime(2025, 1, 30, 13, 0, 0), Notes = "Project review and next steps." },
            new Appointment { Id = 6, ClientId = 106, DateTime = new DateTime(2025, 1, 30, 14, 0, 0), Notes = "Strategy session for upcoming project." },
            new Appointment { Id = 7, ClientId = 107, DateTime = new DateTime(2025, 1, 30, 15, 0, 0), Notes = "Finalizing contract terms." },
            new Appointment { Id = 8, ClientId = 108, DateTime = new DateTime(2025, 1, 30, 16, 0, 0), Notes = "Team collaboration discussion." },
            new Appointment { Id = 9, ClientId = 109, DateTime = new DateTime(2025, 1, 30, 17, 0, 0), Notes = "Client feedback meeting." },
            new Appointment { Id = 10, ClientId = 110, DateTime = new DateTime(2025, 1, 30, 18, 0, 0), Notes = "Quarterly performance review." },
            new Appointment { Id = 11, ClientId = 111, DateTime = new DateTime(2025, 2, 1, 9, 0, 0), Notes = "Initial consultation meeting." },
            new Appointment { Id = 12, ClientId = 112, DateTime = new DateTime(2025, 2, 1, 10, 0, 0), Notes = "Follow-up on previous project." },
            new Appointment { Id = 13, ClientId = 113, DateTime = new DateTime(2025, 2, 1, 11, 0, 0), Notes = "Discuss marketing strategies." },
            new Appointment { Id = 14, ClientId = 114, DateTime = new DateTime(2025, 2, 1, 12, 0, 0), Notes = "Negotiating new terms." },
            new Appointment { Id = 15, ClientId = 115, DateTime = new DateTime(2025, 2, 1, 13, 0, 0), Notes = "Lunch meeting about expansion." },
            new Appointment { Id = 16, ClientId = 116, DateTime = new DateTime(2025, 2, 1, 14, 0, 0), Notes = "Review of upcoming projects." },
            new Appointment { Id = 17, ClientId = 117, DateTime = new DateTime(2025, 2, 1, 15, 0, 0), Notes = "Client satisfaction survey." },
            new Appointment { Id = 18, ClientId = 118, DateTime = new DateTime(2025, 2, 1, 16, 0, 0), Notes = "Team brainstorming session." },
            new Appointment { Id = 19, ClientId = 119, DateTime = new DateTime(2025, 2, 1, 17, 0, 0), Notes = "Sales pitch review." },
            new Appointment { Id = 20, ClientId = 120, DateTime = new DateTime(2025, 2, 1, 18, 0, 0), Notes = "Review project timeline." },
            new Appointment { Id = 21, ClientId = 121, DateTime = new DateTime(2025, 2, 2, 9, 0, 0), Notes = "Consultation with new client." },
            new Appointment { Id = 22, ClientId = 122, DateTime = new DateTime(2025, 2, 2, 10, 0, 0), Notes = "Kickoff meeting for new project." },
            new Appointment { Id = 23, ClientId = 123, DateTime = new DateTime(2025, 2, 2, 11, 0, 0), Notes = "Status update on ongoing project." },
            new Appointment { Id = 24, ClientId = 124, DateTime = new DateTime(2025, 2, 2, 12, 0, 0), Notes = "Feedback and improvement session." },
            new Appointment { Id = 25, ClientId = 125, DateTime = new DateTime(2025, 2, 2, 13, 0, 0), Notes = "Networking event follow-up." },
            new Appointment { Id = 26, ClientId = 126, DateTime = new DateTime(2025, 2, 2, 14, 0, 0), Notes = "Product launch discussion." },
            new Appointment { Id = 27, ClientId = 127, DateTime = new DateTime(2025, 2, 2, 15, 0, 0), Notes = "Internal review meeting." },
            new Appointment { Id = 28, ClientId = 128, DateTime = new DateTime(2025, 2, 2, 16, 0, 0), Notes = "Client onboarding session." },
            new Appointment { Id = 29, ClientId = 129, DateTime = new DateTime(2025, 2, 2, 17, 0, 0), Notes = "Marketing campaign review." },
            new Appointment { Id = 30, ClientId = 130, DateTime = new DateTime(2025, 2, 2, 18, 0, 0), Notes = "Final check before project handover." },
            new Appointment { Id = 31, ClientId = 131, DateTime = new DateTime(2025, 2, 3, 9, 0, 0), Notes = "Team building session." },
            new Appointment { Id = 32, ClientId = 132, DateTime = new DateTime(2025, 2, 3, 10, 0, 0), Notes = "Client progress review." },
            new Appointment { Id = 33, ClientId = 133, DateTime = new DateTime(2025, 2, 3, 11, 0, 0), Notes = "Budget review for next quarter." },
            new Appointment { Id = 34, ClientId = 134, DateTime = new DateTime(2025, 2, 3, 12, 0, 0), Notes = "Partnership meeting." },
            new Appointment { Id = 35, ClientId = 135, DateTime = new DateTime(2025, 2, 3, 13, 0, 0), Notes = "Status update with stakeholders." },
            new Appointment { Id = 36, ClientId = 136, DateTime = new DateTime(2025, 2, 3, 14, 0, 0), Notes = "Internal audit." },
            new Appointment { Id = 37, ClientId = 137, DateTime = new DateTime(2025, 2, 3, 15, 0, 0), Notes = "Contract negotiation." },
            new Appointment { Id = 38, ClientId = 138, DateTime = new DateTime(2025, 2, 3, 16, 0, 0), Notes = "Review of marketing strategies." },
            new Appointment { Id = 39, ClientId = 139, DateTime = new DateTime(2025, 2, 3, 17, 0, 0), Notes = "Final discussion before signing." },
            new Appointment { Id = 40, ClientId = 140, DateTime = new DateTime(2025, 2, 3, 18, 0, 0), Notes = "Wrap-up meeting on latest project." },
            new Appointment { Id = 41, ClientId = 141, DateTime = new DateTime(2025, 2, 4, 9, 0, 0), Notes = "Morning check-in with team." },
            new Appointment { Id = 42, ClientId = 142, DateTime = new DateTime(2025, 2, 4, 10, 0, 0), Notes = "Client meeting to review feedback." },
            new Appointment { Id = 43, ClientId = 143, DateTime = new DateTime(2025, 2, 4, 11, 0, 0), Notes = "Strategy meeting for product launch." },
            new Appointment { Id = 44, ClientId = 144, DateTime = new DateTime(2025, 2, 4, 12, 0, 0), Notes = "Review of financial projections." },
            new Appointment { Id = 45, ClientId = 145, DateTime = new DateTime(2025, 2, 4, 13, 0, 0), Notes = "Team performance feedback session." },
            new Appointment { Id = 46, ClientId = 146, DateTime = new DateTime(2025, 2, 4, 14, 0, 0), Notes = "Product feedback with client." },
            new Appointment { Id = 47, ClientId = 147, DateTime = new DateTime(2025, 2, 4, 15, 0, 0), Notes = "Internal communication update." },
            new Appointment { Id = 48, ClientId = 148, DateTime = new DateTime(2025, 2, 4, 16, 0, 0), Notes = "Collaboration meeting with partner." },
            new Appointment { Id = 49, ClientId = 149, DateTime = new DateTime(2025, 2, 4, 17, 0, 0), Notes = "Client onboarding process discussion." },
            new Appointment { Id = 50, ClientId = 150, DateTime = new DateTime(2025, 2, 4, 18, 0, 0), Notes = "End of day wrap-up." },
            new Appointment { Id = 51, ClientId = 151, DateTime = new DateTime(2025, 2, 5, 9, 0, 0), Notes = "Team project discussion." },
            new Appointment { Id = 52, ClientId = 152, DateTime = new DateTime(2025, 2, 5, 10, 0, 0), Notes = "Discuss product updates." },
            new Appointment { Id = 53, ClientId = 153, DateTime = new DateTime(2025, 2, 5, 11, 0, 0), Notes = "Client follow-up on design." },
            new Appointment { Id = 54, ClientId = 154, DateTime = new DateTime(2025, 2, 5, 12, 0, 0), Notes = "Contract review and signatures." },
            new Appointment { Id = 55, ClientId = 155, DateTime = new DateTime(2025, 2, 5, 13, 0, 0), Notes = "Lunch meeting with a potential partner." },
            new Appointment { Id = 56, ClientId = 156, DateTime = new DateTime(2025, 2, 5, 14, 0, 0), Notes = "Client feedback meeting." },
            new Appointment { Id = 57, ClientId = 157, DateTime = new DateTime(2025, 2, 5, 15, 0, 0), Notes = "Internal team feedback session." },
            new Appointment { Id = 58, ClientId = 158, DateTime = new DateTime(2025, 2, 5, 16, 0, 0), Notes = "Client onboarding and training." },
            new Appointment { Id = 59, ClientId = 159, DateTime = new DateTime(2025, 2, 5, 17, 0, 0), Notes = "Marketing strategy discussion." },
            new Appointment { Id = 60, ClientId = 160, DateTime = new DateTime(2025, 2, 5, 18, 0, 0), Notes = "End of day team check-in." },
            new Appointment { Id = 61, ClientId = 161, DateTime = new DateTime(2025, 2, 6, 9, 0, 0), Notes = "Morning project review." },
            new Appointment { Id = 62, ClientId = 162, DateTime = new DateTime(2025, 2, 6, 10, 0, 0), Notes = "Client consultation and proposal." },
            new Appointment { Id = 63, ClientId = 163, DateTime = new DateTime(2025, 2, 6, 11, 0, 0), Notes = "Product development update." },
            new Appointment { Id = 64, ClientId = 164, DateTime = new DateTime(2025, 2, 6, 12, 0, 0), Notes = "Partnership meeting for new initiatives." },
            new Appointment { Id = 65, ClientId = 165, DateTime = new DateTime(2025, 2, 6, 13, 0, 0), Notes = "Team brainstorming for upcoming event." },
            new Appointment { Id = 66, ClientId = 166, DateTime = new DateTime(2025, 2, 6, 14, 0, 0), Notes = "Sales pitch preparation." },
            new Appointment { Id = 67, ClientId = 167, DateTime = new DateTime(2025, 2, 6, 15, 0, 0), Notes = "Client review of deliverables." },
            new Appointment { Id = 68, ClientId = 168, DateTime = new DateTime(2025, 2, 6, 16, 0, 0), Notes = "Networking call with potential clients." },
            new Appointment { Id = 69, ClientId = 169, DateTime = new DateTime(2025, 2, 6, 17, 0, 0), Notes = "Review marketing analytics." },
            new Appointment { Id = 70, ClientId = 170, DateTime = new DateTime(2025, 2, 6, 18, 0, 0), Notes = "Wrap-up meeting for the day." },
            new Appointment { Id = 71, ClientId = 171, DateTime = new DateTime(2025, 2, 7, 9, 0, 0), Notes = "Project discussion and planning." },
            new Appointment { Id = 72, ClientId = 172, DateTime = new DateTime(2025, 2, 7, 10, 0, 0), Notes = "Client check-in for progress update." },
            new Appointment { Id = 73, ClientId = 173, DateTime = new DateTime(2025, 2, 7, 11, 0, 0), Notes = "Product strategy meeting." },
            new Appointment { Id = 74, ClientId = 174, DateTime = new DateTime(2025, 2, 7, 12, 0, 0), Notes = "Team review and planning for the week." },
            new Appointment { Id = 75, ClientId = 175, DateTime = new DateTime(2025, 2, 7, 13, 0, 0), Notes = "Client contract signing." },
            new Appointment { Id = 76, ClientId = 176, DateTime = new DateTime(2025, 2, 7, 14, 0, 0), Notes = "Feedback session with marketing team." },
            new Appointment { Id = 77, ClientId = 177, DateTime = new DateTime(2025, 2, 7, 15, 0, 0), Notes = "Budget review for next quarter." },
            new Appointment { Id = 78, ClientId = 178, DateTime = new DateTime(2025, 2, 7, 16, 0, 0), Notes = "Team collaboration for product release." },
            new Appointment { Id = 79, ClientId = 179, DateTime = new DateTime(2025, 2, 7, 17, 0, 0), Notes = "Client feedback and next steps." },
            new Appointment { Id = 80, ClientId = 180, DateTime = new DateTime(2025, 2, 7, 18, 0, 0), Notes = "End of day recap with the team." },
            new Appointment { Id = 81, ClientId = 181, DateTime = new DateTime(2025, 2, 8, 9, 0, 0), Notes = "Morning strategy review." },
            new Appointment { Id = 82, ClientId = 182, DateTime = new DateTime(2025, 2, 8, 10, 0, 0), Notes = "Client feedback and project revisions." },
            new Appointment { Id = 83, ClientId = 183, DateTime = new DateTime(2025, 2, 8, 11, 0, 0), Notes = "Team progress meeting." },
            new Appointment { Id = 84, ClientId = 184, DateTime = new DateTime(2025, 2, 8, 12, 0, 0), Notes = "Review project outcomes." },
            new Appointment { Id = 85, ClientId = 185, DateTime = new DateTime(2025, 2, 8, 13, 0, 0), Notes = "Lunch meeting to discuss future plans." },
            new Appointment { Id = 86, ClientId = 186, DateTime = new DateTime(2025, 2, 8, 14, 0, 0), Notes = "Product feedback and improvements." },
            new Appointment { Id = 87, ClientId = 187, DateTime = new DateTime(2025, 2, 8, 15, 0, 0), Notes = "Sales meeting with potential clients." },
            new Appointment { Id = 88, ClientId = 188, DateTime = new DateTime(2025, 2, 8, 16, 0, 0), Notes = "Client check-in on marketing campaigns." },
            new Appointment { Id = 89, ClientId = 189, DateTime = new DateTime(2025, 2, 8, 17, 0, 0), Notes = "End of week review." },
            new Appointment { Id = 90, ClientId = 190, DateTime = new DateTime(2025, 2, 8, 18, 0, 0), Notes = "Wrap-up meeting and planning for next week." },
            new Appointment { Id = 91, ClientId = 191, DateTime = new DateTime(2025, 2, 9, 9, 0, 0), Notes = "Team kickoff meeting for new project." },
            new Appointment { Id = 92, ClientId = 192, DateTime = new DateTime(2025, 2, 9, 10, 0, 0), Notes = "Client proposal presentation." },
            new Appointment { Id = 93, ClientId = 193, DateTime = new DateTime(2025, 2, 9, 11, 0, 0), Notes = "Product testing and improvements." },
            new Appointment { Id = 94, ClientId = 194, DateTime = new DateTime(2025, 2, 9, 12, 0, 0), Notes = "Final review before launch." },
            new Appointment { Id = 95, ClientId = 195, DateTime = new DateTime(2025, 2, 9, 13, 0, 0), Notes = "Feedback session with key stakeholders." },
            new Appointment { Id = 96, ClientId = 196, DateTime = new DateTime(2025, 2, 9, 14, 0, 0), Notes = "Client update and project next steps." },
            new Appointment { Id = 97, ClientId = 197, DateTime = new DateTime(2025, 2, 9, 15, 0, 0), Notes = "Budget meeting for upcoming fiscal year." },
            new Appointment { Id = 98, ClientId = 198, DateTime = new DateTime(2025, 2, 9, 16, 0, 0), Notes = "Team performance feedback session." },
            new Appointment { Id = 99, ClientId = 199, DateTime = new DateTime(2025, 2, 9, 17, 0, 0), Notes = "Marketing strategy meeting." },
            new Appointment { Id = 100, ClientId = 200, DateTime = new DateTime(2025, 2, 9, 18, 0, 0), Notes = "Wrap-up and planning for next month." }
            );
